...
class CoursCatalogueController extends Controller
{
    ...
    public function lireChapitre(Cour $cour, Chapitre $chapitre)
    {
        ...
        if ($chapitre->ordre_affichage === 1) {
            return view('catalogue.chapitre', ['cour' => $cour, 'chapitre' => $chapitre, 'estIntroduction' => true]);
        }
        ...
        return view('catalogue.chapitre', ['cour' => $cour, 'chapitre' => $chapitre, 'estIntroduction' => false]);
    }
}